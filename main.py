...
<style>  
body{background:#0f1720;color:white;font-family:Arial;margin:0;}  .header{
...
</div>  <div id="conditionBar"  
style="padding:8px 16px;font-size:12px;  
opacity:0.8;border-bottom:1px solid #1e293b;">  
기본조건  
</div>  <div id="list" style="padding-bottom:100px;"></div>  <div class="bottom-nav">  
    <a href="/ledger">🏠</a>  
    <a href="/memo">📝</a>  
    <a href="/capture">📸</a>  
    <a href="/favorites">⭐</a>  
</div>  <!-- 필터 모달 -->  <div class="modal" id="filterModal">  
